...
# Mineral properties. Contains mineral bulk modulus, shear modulus and density. Shape should be (N, 3).
mineral_property_np = np.tile(np.array([7.10e10, 3.20e10, 2.71e03]), (dim, 1))

# Fluid properties. Contains fluid bulk modulus and density, viscosity and permeability. Shape should be (N, 4).
